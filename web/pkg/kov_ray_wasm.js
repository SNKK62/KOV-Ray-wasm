...
export function canCompile(input) {
    try {
        ...
        wasm.canCompile(retptr, ptr0, len0);
...
export class Renderer {
    ...
    constructor(input) {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderer_new(ptr0, len0);
    ...
    serializeRenderer() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.renderer_serializeRenderer(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
     ...
     * @param {string} camera_json
     * @returns {Renderer}
     */
    static fromJSON(world_json, config_json, camera_json) {
        ...
        const ptr2 = passStringToWasm0(camera_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.renderer_fromJSON(ptr0, len0, ptr1, len1, ptr2, len2);
     ...
     */
    getHeight() {
        const ret = wasm.renderer_getHeight(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    getWidth() {
        const ret = wasm.renderer_getWidth(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} row
    ...
    renderRow(row) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.renderer_renderRow(retptr, this.__wbg_ptr, row);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('kov_ray_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
